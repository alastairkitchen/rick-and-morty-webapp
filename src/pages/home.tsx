		...
		<Layout title='Homepage' imageUrl="/images/rick-and-morty-header.jpg">
			<div className="site-content__row">
				<div className="site-content__container">
					...
					<p>This site was built as a personal project using the open source <a target='_blank' rel="noreferrer" href='https://rickandmortyapi.com/'>Rick and Morty api</a>, Kudos to <a target='_blank' rel="noreferrer" href="https://github.com/afuh">Axel Fuhrmann</a> for doing a fantastic job!</p>
